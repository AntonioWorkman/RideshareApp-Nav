//package com.uwi.rideshareapp.util
//
...
//    }
//
//    fun updateCurrentUser(name: String = "", bio: String = "", email: String = "", address: String = "", phoneNo: String = "", profilePicturePath: String? = null) {
//        val userFieldMap = mutableMapOf<String, Any>()
//        if (name.isNotBlank()) userFieldMap["name"] = name
//        if (bio.isNotBlank()) userFieldMap["bio"] = bio
//        if (email.isNotBlank()) userFieldMap["email"] = email
//        if (address.isNotBlank()) userFieldMap["address"] = address
//        if (phoneNo.isNotBlank()) userFieldMap["phoneNo"] = phoneNo
